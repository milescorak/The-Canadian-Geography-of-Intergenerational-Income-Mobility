...
CDN <- repmis::source_data("https://raw.githubusercontent.com/milescorak/The-Canadian-Geography-of-Intergenerational-Income-Mobility/master/Data/Percentile_transition_matrix_Canada_All_Cohorts_incomes_above_500.csv")
X <- c(1:100)
Y <- 100*(X*CDN)
Y <- apply(Y,2, mean)
