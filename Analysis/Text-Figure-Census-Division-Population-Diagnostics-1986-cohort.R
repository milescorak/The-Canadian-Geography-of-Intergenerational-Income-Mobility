...
CD.data.1986.1986<- repmis::source_data("https://raw.githubusercontent.com/milescorak/The-Canadian-Geography-of-Intergenerational-Income-Mobility/master/Data/CD_mobility_1986_cohorts_incomes_above_500.csv")
# create and select needed variables

census.division <- CD.data.1986.1986$census.division
province <- CD.data.1986.1986$province
province.name <- CD.data.1986.1986$province.name
